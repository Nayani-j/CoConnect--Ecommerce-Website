...
<head>
  ...
  <style>
    body {
      background-image: linear-gradient(to bottom, #ADD8E6, #CBC3E3);
    }
  ...
  <div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
        ...
        <img src="assets\images\logo\CoConnect.jpg" alt="Co-Connect Logo" class="logo" align="center">
          <h1 align="center">Log In To Co-Connect</h1>
          <p align="center">Please Login to Continue Shopping</p>
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <p class="mb-0" align="center">Don't have an account? <a href="./register.php">Sign Up</a></p>
          </form>
